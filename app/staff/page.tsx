      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500">Manage your employees, roles, and performance.</p>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-4 border-b border-slate-100 flex flex-col md:flex-row gap-4 justify-between">
            ...
            <div className="flex gap-2">
              <button className="px-4 py-2 bg-slate-50 border border-slate-100 rounded-xl text-sm font-medium text-slate-600">All Departments</button>
            </div>
          </div>
                  ...
                  <tr key={s.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-1">
                        <span className="text-xs text-slate-700 font-bold flex items-center gap-1"><Briefcase size={12} /> {s.role}</span>
                        <span className="text-[10px] text-slate-400 uppercase tracking-wider">{s.dept}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 text-sm font-bold text-slate-900">৳{s.salary.toLocaleString()}</td>
                    <td className="px-6 py-4">
                      <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[10px] font-bold rounded uppercase">{s.status}</span>
                    </td>
